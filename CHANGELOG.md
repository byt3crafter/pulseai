...
### Features
- built-in ERPNext skill + ship skill files in the build
...
### Bug Fixes
- always reconnect the chat socket after idle/network/auth failures
...
### Bug Fixes
- mobile-responsive assistant picker, bubbles, sidebar customise
...
### Features
- render pasted CSV/Excel as a scrollable table
...
### Features
- UI knobs for the delegation budget caps

## [0.20.75] - 2026-09-02

### Features
- premium redesign of the chat history list
...
### Bug Fixes
- GLM Coding Plan endpoint + register zai in key validation
...
### Bug Fixes
- ERPNext report endpoint + agent email password never saved

## [0.20.66] - 2026-09-02

### Bug Fixes
- repair every upsert broken by the 0050 partial index

## [0.20.65] - 2026-09-02

### Features
- route Codex narration to thinking + premium answer tables

## [0.20.64] - 2026-09-02

### Bug Fixes
- vertically center the Thinking indicator with the avatar
...
### Bug Fixes
- keep operator tools loaded + stop the endless spinner

## [0.20.61] - 2026-09-01

### Features
- premium thinking indicator (shimmer + orb)

## [0.20.60] - 2026-09-01

### Features
- tighter lean toolset + live activity on the web

## [0.20.59] - 2026-09-01

### Features
- progressive tool disclosure for Codex — load tools by question

### Chores
- pass CODEX_REASONING_EFFORT through to the gateway

## [0.20.58] - 2026-09-01

### Bug Fixes
- isolate every tool registration + regression test

## [0.20.57] - 2026-09-01

### Bug Fixes
- duplicate tool name no longer wipes Codex's whole toolset

## [0.20.56] - 2026-09-01

### Bug Fixes
- stream tokens live + faster default reasoning

## [0.20.55] - 2026-09-01

### Bug Fixes
- delete no longer blocked by FK; in-app confirm modal

## [0.20.54] - 2026-09-01

### Features
- live ChatGPT model list via app-server model/list

## [0.20.53] - 2026-09-01

### Features
- searchable, provider-grouped model picker
...
### Bug Fixes
- agent states its real model instead of confabulating
...
### Features
- model groups — auto-pick from a configured set, zero hardcoding

## [0.20.47] - 2026-08-31

### Bug Fixes
- endpoints from config, not a hardcoded switch
...
### Features
- logins carry the customer's brand, and match the reference polish

## [0.20.44] - 2026-08-28

### Bug Fixes
- every unauthenticated page follows the theme

## [0.20.43] - 2026-08-28

### Features
- Clerk-style centred logins, on tokens, no hardcoded company
...
### Bug Fixes
- settings changes now reach a live conversation

## [0.20.40] - 2026-08-28

### Bug Fixes
- an agent asked what it can do must answer with its skills
...
### Bug Fixes
- a huge repo no longer kills the gateway; folder URLs import that folder
...
### Features
- Phase 5 — memory belongs to the person
...
### Bug Fixes
- new chats were saved and instantly invisible

## [0.20.29] - 2026-08-27

### Bug Fixes
- deleting a chat no longer fails, and stops destroying billing history

## [0.20.28] - 2026-08-27

### Bug Fixes
- rebuild the list to the pattern every mail client uses
...
### Bug Fixes
- chats open when clicked, and can be deleted
...
### Bug Fixes
- page scroll, empty chat history, and select-all

## [0.20.22] - 2026-08-27

### Features
- one line per row, full record behind a click

## [0.20.21] - 2026-08-27

### Bug Fixes
- placeholder overlapping the controls on a phone
...
### Bug Fixes
- nav rows to the artboard's 32px

## [0.20.18] - 2026-08-27

### Bug Fixes
- sidebar spacing and density, measured against the artboard
