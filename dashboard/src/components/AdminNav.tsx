            ...
            {links.map(({ href, label, icon: Icon, exact }) => {
                ...
                return (
                    <Link
                        ...
                        className={`relative flex items-center gap-2.5 px-3 py-2 rounded text-[13px] transition-colors motion-reduce:transition-none focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-[#F5A524] ${
                            isActive
                                ? "text-[#F5A524] bg-[#141210]"
