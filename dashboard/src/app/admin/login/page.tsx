                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <div>
                            ...
                            <input
                                ...
                                className="w-full px-3 py-2.5 border border-slate-700 rounded-lg bg-slate-800 text-white placeholder:text-slate-600 focus:ring-2 focus:ring-[#8B5CF6] focus:border-[#8B5CF6] outline-none text-sm"
                                value={email}
                        ...
                        <div>
                            <div className="flex items-center justify-between mb-1.5">
                                ...
                                <Link href="/forgot" className="text-xs font-medium text-[#8B5CF6] hover:text-[#A78BFA] normal-case tracking-normal">Forgot password?</Link>
                            </div>
                            <input
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full bg-[#8B5CF6] hover:bg-[#A78BFA] text-white font-semibold py-2.5 rounded-lg transition-colors mt-2 disabled:opacity-60 flex items-center justify-center gap-2 text-sm"
                        >
                            {loading ? (
                                <>
